"""
Django settings for fragrant_smoke_dev_64654 project.
...
ROOT_URLCONF = 'fragrant_smoke_dev_64654.urls'
...
WSGI_APPLICATION = 'fragrant_smoke_dev_64654.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_smoke_dev_64654 API",
    "DESCRIPTION": "API documentation for fragrant_smoke_dev_64654 App",
    "VERSION": "v1",
}
