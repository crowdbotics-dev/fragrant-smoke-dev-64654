...
## Project Structure
    ...
    ├── fragrant_smoke_dev_64654  # Django project configurations
...
1. Clone this repo and `cd fragrant_smoke_dev_64654`
...
2. Clone this repo and `cd fragrant_smoke_dev_64654`
